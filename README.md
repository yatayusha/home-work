...
# Задание (альтернативный метод шифрования - с помощью ключей)
...
После выполнения дешифрования, прикрепите скриншот с результатом (вывод исходного текста, записанного в файл)
